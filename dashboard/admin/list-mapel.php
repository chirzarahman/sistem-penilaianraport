                                                                        ...
                                                                        <div class="sm:flex sm:items-start">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <h3 class="text-lg leading-6 font-medium text-gray-900"
                                                                                    id="modal-headline">Hapus item
                                                                                </h3>
                                                                                <div class="mt-2">
                                                                                    <p class="text-sm text-gray-500">
                                                                                        Apakah kamu serius menghapus
                                                                                        <span class="font-bold">item
                                                                                            ini</span>?
                                                                                    </p>
                                                                                </div>
                                                                            </div>
